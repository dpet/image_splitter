		...
		<div class="row">
			<div class="col-sm-5 col-sm-offset-1 col-lg-4">
				...
				<div class="col-xs-9 col-xs-offset-3">
					...
					<button class="btn btn-primary" onclick="flip_image()">Flip</button>
					<button class="btn btn-primary" onclick="set_quad()" id="quad_button">x4</button>
				</div>
			</div>
			...
			<div class="col-sm-6">
				...
				<div class="col-xs-9 col-md-6">
					<input type="range" class="form-control" min="-50" max="100" value="0" oninput="set_offset(this.value)" onchange="set_offset(this.value)" id="position_slider">
				</div>
